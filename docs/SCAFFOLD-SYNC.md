...
|---|---|---|---|---|
| v0.46.0 | applied | 2026-09-04 | The complete released origin/current coupling group was already present locally: immutable origin with legacy fallback, origin-based sync/triage floor, current-version reporting, and child init stamping. Advanced the evaluated current version after comparing tag `d0c9145970e69626318a26ce922650f1a631c2f0`; no divergent file was replaced wholesale. Origin v0.29.0; current v0.46.0. | upstream v0.46.0 |
