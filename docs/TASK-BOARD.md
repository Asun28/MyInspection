...
| W0 | T0-SCAFFOLD-LEAN-CI | 普通产品 PR 不启动 scaffold-only 六分片；脚手架权威面变化仍全跑 | T0-HARNESS-PERF | S | GPT-5.6 Terra · high | DeepSeek V4 Pro | 配置/文档删除优先：不改 scripts、R3、verify、job 或测试框架；基线 PR #5–#11 = 60 runs / 360 shard jobs |
