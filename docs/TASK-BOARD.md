...
| W0 | T0-DEBT-MUTATION-RESTORE-SAFETY | 把 L214 的 mutation 还原防丢纪律晋升为必须层（TD147） | — | S | GPT-5.6 Terra · high | Sonnet 5 max | blocking lesson 已达门槛；只改 CLAUDE/LEDGER，must 9→10，不触 selftest |
