...
| W0 | T0-DEBT-WINDOWS-PYTHON-UTF8 | 把 L162 的 Windows Python UTF-8 工具纪律合并进脚本工具铁律（TD152） | T0-DEBT-POWERSHELL-DETACHED-ENCODING | S | GPT-5.6 Terra · high | Sonnet 5 max | blocking lesson；四 ID 合并保持 CLAUDE 必须层 10 条，不触 selftest |
