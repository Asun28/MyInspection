...
| W0 | T0-DEBT-MUTATION-BATCH-COUNT | 把 L177 的 mutation 批次条数自证纪律合并进 L17 铁律（TD148） | T0-DEBT-MUTATION-RESTORE-SAFETY | S | GPT-5.6 Terra · high | Sonnet 5 max | blocking lesson；双 ID 合并保持 CLAUDE 必须层 10 条，不触 selftest |
