...
| W0 | T0-DEBT-UNSAFE-PATH-DELEGATION | 把 L171 的不安全路径不得委托下游纪律晋升为必须层（TD153） | T0-DEBT-MUTATION-RESTORE-SAFETY | S | GPT-5.6 Terra · high | Sonnet 5 max | blocking lesson；独立安全铁律 + 合并 L196/L214 保持 CLAUDE 必须层 10 条，不触 selftest |
