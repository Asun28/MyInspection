...
| W5 | T3-E2E-GOLDEN-FIXTURE | 冻结 canonical inspection/photo/report/redaction 黄金夹具 | T2-ROUTINE-CONTENT | S | DeepSeek V4 Pro · high | Sonnet 5 max | — |
| W5 | T3-E2E-HASH | 真实 JVM 闭环验证 fixture/DB/报告/独立重算 hash | T3-E2E-GOLDEN-FIXTURE,T3-FINALIZE,T3-REPORT-COMPOSER,T2-CAPTURE-CORE,T2-PHOTO-PIPELINE | M | DeepSeek V4 Pro · high | Sonnet 5 max | — |
| W5 | T3-E2E-TENANT-REDACTION | tenant report landlord/private sentinel 防泄露 | T3-E2E-HASH | S | DeepSeek V4 Pro · high | Sonnet 5 max | — |
| W5 | T3-E2E-CORE | 已验收 JVM e2e fail-closed 接 verify Gate 2 | T3-E2E-TENANT-REDACTION | S | DeepSeek V4 Pro · high | Sonnet 5 max | — |
