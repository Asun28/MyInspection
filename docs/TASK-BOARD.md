...
| W0 | T0-LICENSE-GAV-BOUNDS | GAV 每段上界，使 exact accepted coordinate 与有界诊断可同时成立（TD135；TD2 4/5） | T0-LICENSE-DIAGNOSTICS | M | GPT-5.6 Terra · max | Sonnet 5 max | **ready**；独占 scanner/test，执行/合并宽度=1 |
