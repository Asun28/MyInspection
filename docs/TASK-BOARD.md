...
| W0 | T0-DEBT-MUTATION-EVIDENCE-CLASSIFIER | 把 L167 的 mutation 判据分类器纪律合并进 L165 铁律（TD149） | T0-DEBT-MUTATION-BATCH-COUNT | S | GPT-5.6 Terra · high | Sonnet 5 max | blocking lesson；双 ID 合并保持 CLAUDE 必须层 10 条，不触 selftest |
