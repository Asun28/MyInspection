...
| W0 | T0-DEBT-POWERSHELL-DETACHED-ENCODING | 把 L172 的 detached pwsh 编码纪律合并进 L17/L177 铁律（TD150） | T0-DEBT-MUTATION-BATCH-COUNT | S | GPT-5.6 Terra · high | Sonnet 5 max | blocking lesson；三 ID 合并保持 CLAUDE 必须层 10 条，不触 selftest |
