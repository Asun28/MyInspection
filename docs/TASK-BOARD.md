...
| W0 | T0-DEBT-SELFTEST-SNAPSHOT-BASELINE | 让 selftest all 快照钉住调用者 HEAD 与权威 master（TD156） | — | S | GPT-5.6 Sol · high | Codex R3 | detached/stale-master hostile fixture；只改 selftest，PR #33 后续须在新 master 重放 |
