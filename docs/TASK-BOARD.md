...
| W0 | T0-DEBT-R3-QUOTA-ROUND-CLASSIFICATION | 把 L21 的 R3 配额/轮次证据分类纪律合并进 L205 铁律（TD155） | — | S | GPT-5.6 Terra · high | Sonnet 5 max | reviewer operational failure 先确诊；双 ID 合并保持 CLAUDE 必须层 10 条，不触 review/selftest |
