...
| W0 | T0-DEBT-UNICODE-SANITIZER-CATEGORIES | 把 L181 的 Unicode sanitizer 类别纪律合并进 L193 铁律（TD151） | — | S | GPT-5.6 Terra · high | Sonnet 5 max | blocking lesson；双 ID 合并保持 CLAUDE 必须层 10 条，不触 selftest |
