...
class ReportComposerPaginationTest {
    ...
    /* R4: both compiling budget mutations produced fresh named java.lang.AssertionError results.
     * Composer source SHA-256: 5297B78BF90124BD67DE88FCA8FA20853A9139BD4D404BFE8DE24D2D40662293
     * M1: splitItemRow continuation reuses firstMaxHeightMm ->
     * room opening uses its reduced budget only for the first item chunk: successful-compose assertion.
     * M2: splitBlock continuation reuses firstMaxHeightMm ->
     * section opening uses its reduced budget only for the first flowing chunk: expected [246, 254, 30], actual [246, 246, 38].
     * Original production bytes and the SHA-256 above were restored after each mutation.
     */
    @Test
