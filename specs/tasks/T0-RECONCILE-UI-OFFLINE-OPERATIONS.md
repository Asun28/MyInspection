...
non_goals:
  - 通知、日程、采集、历史与 PDF 卡
acceptance:
  - "A1 backup security dependency + fields/states exact"
  - "A2 media acceptance exact"
  - "A3 remediation/network exact"
  - "A4 smoke erase/health dependencies + acceptance exact"
...
dod_exit: 0
dod_assert: A1–A5 exact dependencies + unique-field mutations
