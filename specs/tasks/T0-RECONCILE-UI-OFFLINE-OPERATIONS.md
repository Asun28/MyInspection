...
acceptance:
  - "A1 Backup IO：plan_ref + A1–A5；backup_states 字段精确登记 10 states，覆盖 phases、verified receipt、staging/rollback、provider/authorization/storage/secret failure 与本地/USB 飞行模式"
