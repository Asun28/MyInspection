...
non_goals:
  - 采集、报告、备份、健康或清除卡
acceptance:
  - "A1 Notices：plan_ref、A1–A4、center/compose 与五状态"
  - "A2 Copy≠送达；Record delivery 需 method/time"
  - "A3 Schedule：plan_ref、A1–A4、due/filter/route/reminder"
  - "A4 仅改 plan_ref/acceptance"
