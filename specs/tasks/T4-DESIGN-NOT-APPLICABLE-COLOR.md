...
落空。补齐后两侧对称。此缺口在基线即存在（`optionalColor` 本就是 `outline`），本卡只是把它放大到必须收口。

### R4 变异收据

基线（GREEN 态）`context/DESIGN.md` SHA-256 =
`eb5c19adf3c991d4eac8505513fddde2d7158c9cca52ad19c3de0bb3458640af`；批后同文件 SHA-256 逐位相同，
