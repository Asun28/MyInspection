...
acceptance:
  - "A1 due, empty, and filter views use a state badge"
  - "A2 each property opens the correct inspection route"
  - "A3 schedule uses a 13-week local reminder cadence"
  - "A4 scheduling works offline and explains permission failure"
