...
depends_on: [T1-CANON-HASH, T1-TEMPLATE-ENGINE, T2-CAPTURE-CORE]
parallelizable_with: [T2-CAPTURE-UI]
status: todo
...
dod_command: cmd /c android\gradlew.bat -p android --offline --no-daemon -q :core:test --tests "nz.myinspection.core.report.*" --rerun-tasks --no-build-cache
dod_exit: 0
