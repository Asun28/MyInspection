...
版本：V1 的规则导入前置设计。2026-09-08 用户在完整 ADR 0008 与明确责任问题后回复“好的”，批准单公钥离线签名、本人批准规则、受控电脑分开保管规则与 APK 私钥、USB 首次可信安装/规则传递及配套版本/日期/恢复策略。真实公钥与制品安装证据由导入卡提供，设计批准不等于这些产物已经存在；本卡待正式 R3 pass 与合并，未解除导入依赖。
