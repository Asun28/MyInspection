...
2026-09-06: the user approved this predecessor after T3-DOCX-REPORT-EXTRACTOR received two R3 blocks. The second finding is reproduced through the public package reader: a 33-byte PNG IHDR or a JPEG ending after SOF was incorrectly excluded. Both verdicts and the original implementation remain preserved; this split does not waive review or change its size/round thresholds. After this card merges, the extractor replaces its local dimensions helper with this result and retains unqualified images with IMAGE_REVIEW_REQUIRED.
