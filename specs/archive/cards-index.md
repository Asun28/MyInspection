...
> 一行一条已 `merged` 的卡，共 228 张；完整卡在 `specs/archive/tasks/<id>.md`。
...
| T1-STORAGE-PATH-BOUNDARY-REMOTE | merged | Remote delivery of verified storage path snapshots and checked child directories |
